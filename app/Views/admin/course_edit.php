                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="level" name="level">
                                    <option value="beginner" <?= old('level', $course['level'] ?? 'beginner') == 'beginner' ? 'selected' : '' ?>>Beginner</option>
                                    <option value="intermediate" <?= old('level', $course['level'] ?? 'beginner') == 'intermediate' ? 'selected' : '' ?>>Intermediate</option>
                                    <option value="advanced" <?= old('level', $course['level'] ?? 'beginner') == 'advanced' ? 'selected' : '' ?>>Advanced</option>
                                </select>
                            </div>
